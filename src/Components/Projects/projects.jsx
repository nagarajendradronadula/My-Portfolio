  ...
  return (
    <div id="Projects" className="p-10 md:p-24 text-white">
        ...
        <div className="py-12 px-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <ProjectCard title="DNR - Portfolio" main="This project is a personal portfolio website built with React, featuring various sections such as Home, About, Skills, Projects, and Footer." githubLink="https://github.com/nagarajendradronadula/My-Portfolio" liveLink="https://dnr-portfolio.vercel.app/" />
